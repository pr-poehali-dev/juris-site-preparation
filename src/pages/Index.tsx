...
const CASES = [
  ...
  {
    category: "Спор с ПАО «АЛРОСА»",
    title: "Уменьшение неустойки по договору поставки",
    caseNumber: "А58-11224/2024",
    opponent: "ПАО «АЛРОСА»",
    amount: "× 10",
    result: "Неустойка снижена",
    resultColor: "text-emerald-700",
    desc: "Очередная победа в споре с ПАО «АЛРОСА». Представляла интересы ответчика по договору поставки: на основании ст. 333 ГК РФ суд снизил заявленную неустойку в 10 раз, признав её несоразмерной последствиям нарушения обязательства. Точные суммы доступны в карточке дела на КАД.Арбитр.",
