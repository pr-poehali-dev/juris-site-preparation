...
const CASES = [
  ...
  },
  {
    ...
    resultColor: "text-emerald-700",
    desc: "Проигрыш в первой инстанции — не приговор. Представитель Закарьяева Патимат добилась отмены решения суда первой инстанции и в апелляции выиграла дело: суд обязал покупателя принять товар по договору поставки на сумму 4,2 млн ₽. Грамотная процессуальная стратегия и переоценка доказательств перевернули исход спора.",
