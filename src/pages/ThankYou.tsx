  ...
  return (
    <main className="bg-paper min-h-screen flex items-center">
      <div className="max-w-xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-lime mb-8">
        ...
        <Link
          to="/"
          className="mt-10 inline-flex items-center gap-2 bg-graphite-900 text-paper-50 font-golos text-sm font-medium px-7 py-4 hover:bg-lime hover:text-graphite-900 transition-all duration-300"
        >
